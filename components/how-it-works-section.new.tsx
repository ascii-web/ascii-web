      ...
      <div className="max-w-6xl mx-auto">
        <GlitchContainer>
          <h2 className="text-3xl md:text-5xl font-bold text-center mb-16">
            <GlitchText text="From Prompt to Masterpiece: Our Process" className="text-terminal-green" />
          </h2>
        </GlitchContainer>
            ...
            <GlitchContainer delay={200}>
              <div className="relative bg-gray-900 border border-terminal-green/30 rounded-lg p-6 transform transition-transform hover:scale-[1.02]">
                <div className="absolute -top-3 left-6 bg-black px-3 py-1 border border-terminal-green/50 rounded">
                  <GlitchText text="Terminal Window" className="text-terminal-green text-sm font-semibold" />
                </div>
                ...
                <div className="mt-4">
                  ...
                  <h3 className="text-xl font-bold mb-4">
                    <GlitchText text="1. Your Concept" className="text-terminal-green" />
                  </h3>
